...
export default async function EventPage({params}){
    ...
    return ( event ? 
        <>
            ...
            <h1 className="mt-6 md:ml-20 text-2xl md:text-3xl text-center p-2">{event.title}</h1>  

            <div className="flex md:flex-row flex-col justify-between p-2 mt-6 border-2"> 
                <div className="flex md:flex-row flex-col w-full justify-center p-12 md:p-2 gap-12">
                    ...
                    <div className="flex flex-col md:text-xl mr-20 ">                            
                ...
                <br></br>
                {/* <div className="border-2 p-2 mx-2 my-2">
                    <p>Posts</p>
                    <p>New message box:</p>
                    <input className="border rounded-sm"/>
                    <button className="border text-white border-[#363a4115] px-4 py-[0.5px]  items-center rounded 
                                        shadow-sm hover:shadow-md hover:bg-[#4651f1a6] bg-[#4651f1c0] transition duration-300"
                    >Send</button>
                    <PostCard/>
                    <PostCard/>
                    <PostCard/>
                ...
                {isHost &&  
                    <div className="flex flex-col md:w-1/3 p-4 gap-2 md:border-l-2 mt-2 md:mt-0">
